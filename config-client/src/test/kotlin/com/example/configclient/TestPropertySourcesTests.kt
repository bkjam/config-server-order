...
class TestPropertySourcesTests {
	@Autowired
	...
	fun customProperty() {
		...
		Assertions.assertEquals("@TestPropertySources - src/test/resources/application-integrationtest.properties", customEnvProperty)
		Assertions.assertEquals("@TestPropertySources - src/test/resources/application-integrationtest.properties", customProperty)
	}
}
